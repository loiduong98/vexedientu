...
class Home extends Component {
    ...
    render() {
        ...
        return ( <
            ...
            <
            div className = "card card-raised card-background"
            style = {
                {
            ...
            the human foundation in truth And I love you like Kanye loves Kanye I love Rick Owens’ bed design but the back is... <
            /p> <
            a href = "#pablo"
            ...
            style = {
                {
                    backgroundImage: 'url("assets/img/examples/card-blog3.jpg")',
                }
            } >
            <
            div className = "card-body" >
            ...
            style = {
                {
                    backgroundImage: 'url("assets/img/examples/card-project6.jpg")',
                }
            } >
            <
            div className = "card-body" >
